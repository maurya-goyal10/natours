...
},{"./lib/axios":"../../node_modules/axios/lib/axios.js"}],"login.mjs":[function(require,module,exports) {
"use strict";
...
exports.login = login;
},{"axios":"../../node_modules/axios/index.js"}],"mapbox.mjs":[function(require,module,exports) {
"use strict";
...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoibWF1cnlhMjAiLCJhIjoiY2t1bGo3ams0MTQ5MzJ3bzY4N2drZWhjMSJ9.0hKezkbmhTFjUeFHYwtRWg';
  ...
  locations.forEach(function (loc) {
    ...
    new mapboxgl.Popup({
      offset: 30
    }).setLngLat(loc.coordinates).setHTML("<p>Day ".concat(loc.day, ": ").concat(loc.description, "</p>")).addTo(map); //extend the map to include the marked locations
...
var _mapbox = require("./mapbox.mjs");
...
},{"./login.mjs":"login.mjs","./mapbox.mjs":"mapbox.mjs"}],"../../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
